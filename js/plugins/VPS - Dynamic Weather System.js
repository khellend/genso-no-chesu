// ----------------------------------------------------------------------------------------
// VPS (动态天气系统) - Dynamic Weather System
// Author: Soulpour777
// ----------------------------------------------------------------------------------------
/*:
* @plugindesc v1.0 动态天气系统 An extended weather system for RMMV with different effects and behaviors.
* @author Soulpour777
*
@help
...
HOW TO CREATE AND CALL A WEATHER 建立并调用天气
To call the weather that you want, you need to use
the plugin command:

startWeather name power duration 命令 名字 强度 持续性
...
已制定的天气清单 Here is the list of all the weather types you can do:
...
have to use a plugin command 停止天气指令:
...
useDimmer
使用高光器 to use the Dimmer and
stopDimmer
关闭高光器 to stop using the Dimmer.
...
* @desc Autumn Leaf Speed Movement Ax value. (Horizontal Movement 枫叶横飘速度)
* @default 0
*
* @param AutumnLeafSpeedY
* @desc Autumn Leaf Speed Movement Ay value. (Vertical Movement 枫叶纵飘速度)
* @default 1
*
* @param AutumnLeafOpacity
* @desc Autumn Leaf Opacity when created. (Created / Deleted 枫叶透明度)
* @default 1
*
* @param SakuraSpeedX
* @desc Sakura Speed Movement Ax value. (Horizontal Movement 樱花横飘速度)
* @default 0
*
* @param SakuraSpeedY
* @desc Sakura Speed Movement Ay value. (Vertical Movement 樱花纵飘速度)
* @default 1
*
* @param SakuraOpacity
* @desc Sakura Opacity when created. (Created / Deleted 樱花透明度)
* @default 1
*
* @param BlowingSakuraSpeedX
* @desc Blowing sakura speed (Horz Movement 平吹樱花速度)
* @default 3
*
* @param BlowingSakuraSpeedY
* @desc Blowing sakura speed (Vert Movement 纵吹樱花速度)
* @default 3
*
* @param BlowingSakuraOpacity
* @desc Blowing sakura Opacity 吹樱花透明度
* @default 1
*
* @param CloverSpeedX
* @desc Clover Speed Movement Ax value. (Horizontal Movement 三叶草横飘速度)
* @default 0
*
* @param CloverSpeedY
* @desc Clover Speed Movement Ay value. (Vert Movement 三叶草纵飘速度)
* @default 1
*
* @param CloverOpacity
* @desc Clover Opacity 三叶草透明度
* @default 1
*
*
* @param BlowingCloverSpeedX
* @desc Blowing Clover Speed Movement Ax value. (Horizontal Movement 平吹三叶草速度)
* @default 3
*
* @param BlowingCloverSpeedY
* @desc Blowing Clover Speed Movement Ay value. (Vert Movement 纵吹三叶草速度)
* @default 0
*
* @param BlowingCloverOpacity
* @desc Blowing Clover Opacity. 吹三叶草透明度
* @default 1
*
* @param BlowingAutumnSpeedX
* @desc Blowing Autumn Speed Movement Ax value. (Horizontal Movement 平吹枫叶速度)
* @default 10
*
* @param BlowingAutumnSpeedY
* @desc Blowing Autumn Speed Movement Ay value. (Vert Movement 纵吹枫叶速度)
* @default 0
*
* @param BlowingAutumnOpacity
* @desc Blowing Autumn Opacity. 吹枫叶透明度
* @default 1
*
* @param -STORM CONTROL-
* 
* @param LightningDuration
* @desc The duration before another lightning flashes. (Value by numbers 闪电间歇).
* @default 300000
* 
* @param LightningCounter
* @desc The speed of counting for another lightning flash. (Value by numbers 闪电速度).
* @default 10
* 
* @param ThunderclapAudio
* @desc The audio name of the SE you are going to use when you are using Realistic Storm.风暴声
* @default Thunder1
*
* @param ThunderclapVolume
* @desc The volume of the SE you are going to use when you are using Realistic Storm.风暴声大小
* @default 100
*
* @param ThunderclapPitch
* @desc The pitch of the SE you are going to use when you are using Realistic Storm.风暴声调
* @default 100
*
* @param ThunderclapPan
* @desc The sound panning of the SE you are going to use when you are using Realistic Storm.风暴回声
* @default 0
*
* @param -WEATHER RESOURCES-
*
* @param SnowballImage
* @desc Image name of your snowball weather image.雪球图片
* @default snowball
*
* @param FlakeImage
* @desc Image name of your flake weather image.雪花图片
* @default flake
*
* @param BlizzardImage
* @desc Image name of your realistic blizzard weather image.暴风雪图片
* @default blizzard
*
* @param IceImage
* @desc Image name of your ice weather image.冰雪图片
* @default ice
*
* @param GlitterImage
* @desc Image name of your glitter weather image.闪电图片
* @default glitter
*
* @param FireImage
* @desc Image name of your fire weather image.火焰图片
* @default fire
*
* @param LightImage
* @desc Image name of your light weather image.灯光图片
* @default light
*
* @param MeteorImage
* @desc Image name of your meteor weather image.流星图片
* @default meteor
*
* @param LeafBladeImage
* @desc Image name of your leafblade weather image.流星雨图片
* @default leafblade
*
* @param PollenImage
* @desc Image name of your pollen weather image.花粉图片
* @default pollen
*
* @param FairydustImage
* @desc Image name of your fairydust weather image.烟尘图片
* @default fairydust
*
* @param LeafImage
* @desc Image name of your leaf weather image.落叶图片
* @default leaf
*
* @param AutumnLeafImage
* @desc Image name of your autumnleaf weather image.枫叶图片
* @default autumnleaf
*
* @param SpringLeafImage
* @desc Image name of your springleaf weather image.绿叶图片
* @default springleaf
*
* @param CloverImage
* @desc Image name of your clover weather image.三叶草图片
* @default clover
*
* @param SakuraImage
* @desc Image name of your sakura weather image.樱花图片
* @default sakura
*
* @param FlakeImage
* @desc Image name of your flake weather image.雪花图片
...
*
* @param BubbleImage
* @desc Image name of your underwater weather image.水下图片
* @default bubble
*
* @param WingImage
* @desc Image name of your wing weather image.刮风图片
* @default wing
*
* @param WaterImage
* @desc Image name of your water weather image.积水图片
* @default water
*
*/
